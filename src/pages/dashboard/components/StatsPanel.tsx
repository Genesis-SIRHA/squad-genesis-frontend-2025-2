    ...
    return (
        <div className="flex flex-row h-1/3 gap-8">
            <div className="flex flex-col h-full w-2/3">
                <div
                    className="flex flex-row items-center justify-between p-5 w-full h-full rounded-xl bg-white shadow-sm">
                    {role === "STUDENT" && (
                        <>
                                ...
                                <div className="flex flex-row items-center w-full h-full">
                                    ...
                                    <div className="flex flex-col gap-2 mt-2">
                                        <div className="flex items-center gap-3">
                                            <div
                                                className="w-8 h-8 bg-secondary-success text-white text-xs font-semibold flex items-center justify-center rounded-sm">
                                                {progressPercentage}%
                                            </div>
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div
                                                className="w-8 h-8 bg-secondary-neutral text-white text-xs font-semibold flex items-center justify-center rounded-sm">
